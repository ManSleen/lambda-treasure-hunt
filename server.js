...
const traverseMap = async () => {
  ...
  // While only runs if 'visited' graph's rooms have any "?" exits
  // AND
  // 'visited' graph's length is less than 500
  // while (
  //   checkIfBothTrue(!graphIsComplete(), Object.keys(visited).length < 500)
  // ) {

  // }
  previousRoom = currentRoom;
  currentRoom = await move("w", currentRoom);
